<template>
  <!-- Source: https://github.com/MicroDroid/vue-materialize-datatable -->
  ...
  <div class="card material-table" ref="table">
    <div class="table-header">
      ...
      <div class="actions">
        <a
          v-for="(button, index) in customButtonsArray"
          :key="index"
...
export default {
  ...
  computed: {
    customButtonsArray() {
      return this.customButtons.filter((button) =>
        button && button.hide ? !button.hide : true
      );
    },
